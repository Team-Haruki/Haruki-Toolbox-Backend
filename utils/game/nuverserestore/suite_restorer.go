...
// SuiteRestorer holds parsed field definitions and exposes RestoreFields.
type SuiteRestorer struct {
	fields map[string][]fieldDef
}

// SuiteRestoreReport describes one in-place suite restore run.
type SuiteRestoreReport struct {
	RestoredFields int
	FailedFields   []string
}

// NewSuiteFromDefinitions creates a SuiteRestorer from StructTool-derived field definitions.
func NewSuiteFromDefinitions(raw map[string][]any) (*SuiteRestorer, error) {
	...
	return &SuiteRestorer{fields: fields}, nil
}
...
func (r *SuiteRestorer) RestoreFields(data map[string]any) map[string]any {
...
// treated as failures.
func (r *SuiteRestorer) RestoreFieldsWithReport(data map[string]any) (map[string]any, SuiteRestoreReport) {
