...
func (d *cursor) validateValue(depth, maxDepth int) error {
	if depth > maxDepth {
...
func (d *cursor) validateArray(n, depth, maxDepth int) error {
...
func (d *cursor) validateMap(n, depth, maxDepth int) error {
	if n < 0 || n > len(d.data)-d.off {
