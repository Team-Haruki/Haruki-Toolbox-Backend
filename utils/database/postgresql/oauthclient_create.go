...
func (_c *OAuthClientCreate) AddAuthorizationIDs(ids ...int) *OAuthClientCreate {
	_c.mutation.AddAuthorizationIDs(ids...)
	return _c
}

// AddAuthorizations adds the "authorizations" edges to the OAuthAuthorization entity.
func (_c *OAuthClientCreate) AddAuthorizations(v ...*OAuthAuthorization) *OAuthClientCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *OAuthClientCreate) AddTokenIDs(ids ...int) *OAuthClientCreate {
	_c.mutation.AddTokenIDs(ids...)
	return _c
}

// AddTokens adds the "tokens" edges to the OAuthToken entity.
func (_c *OAuthClientCreate) AddTokens(v ...*OAuthToken) *OAuthClientCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *OAuthClientCreate) check() error {
	if _, ok := _c.mutation.ClientID(); !ok {
		return &ValidationError{Name: "client_id", err: errors.New(`postgresql: missing required field "OAuthClient.client_id"`)}
	}
	...
	if _, ok := _c.mutation.ClientSecret(); !ok {
		return &ValidationError{Name: "client_secret", err: errors.New(`postgresql: missing required field "OAuthClient.client_secret"`)}
	}
	...
	if _, ok := _c.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`postgresql: missing required field "OAuthClient.name"`)}
	}
	...
	if _, ok := _c.mutation.ClientType(); !ok {
		return &ValidationError{Name: "client_type", err: errors.New(`postgresql: missing required field "OAuthClient.client_type"`)}
	}
	if _, ok := _c.mutation.RedirectUris(); !ok {
		return &ValidationError{Name: "redirect_uris", err: errors.New(`postgresql: missing required field "OAuthClient.redirect_uris"`)}
	}
	if _, ok := _c.mutation.Scopes(); !ok {
		return &ValidationError{Name: "scopes", err: errors.New(`postgresql: missing required field "OAuthClient.scopes"`)}
	}
	if _, ok := _c.mutation.Active(); !ok {
		return &ValidationError{Name: "active", err: errors.New(`postgresql: missing required field "OAuthClient.active"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`postgresql: missing required field "OAuthClient.created_at"`)}
	}
	return nil
}
