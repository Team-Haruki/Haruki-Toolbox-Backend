...
type GroupEdges struct {
	// GroupList holds the value of the group_list edge.
...
// GroupListOrErr returns the GroupList value or an error if the edge
// was not loaded in eager-loading.
func (e GroupEdges) GroupListOrErr() ([]*GroupList, error) {
	if e.loadedTypes[0] {
		return e.GroupList, nil
	}
	return nil, &NotLoadedError{edge: "group_list"}
}
...
// QueryGroupList queries the "group_list" edge of the Group entity.
func (_m *Group) QueryGroupList() *GroupListQuery {
	return NewGroupClient(_m.config).QueryGroupList(_m)
}
...
func (_m *Group) Unwrap() *Group {
	...
	if !ok {
		panic("postgresql: Group is not a transactional entity")
	}
