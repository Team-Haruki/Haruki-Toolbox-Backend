...
func (e WebhookSubscriptionEdges) EndpointOrErr() (*WebhookEndpoint, error) {
	if e.Endpoint != nil {
...
func (*WebhookSubscription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case webhooksubscription.FieldUserID, webhooksubscription.FieldServer, webhooksubscription.FieldDataType, webhooksubscription.FieldWebhookID:
...
// QueryEndpoint queries the "endpoint" edge of the WebhookSubscription entity.
func (_m *WebhookSubscription) QueryEndpoint() *WebhookEndpointQuery {
	return NewWebhookSubscriptionClient(_m.config).QueryEndpoint(_m)
}
...
func (_m *WebhookSubscription) Unwrap() *WebhookSubscription {
	...
	if !ok {
		panic("postgresql: WebhookSubscription is not a transactional entity")
	}
